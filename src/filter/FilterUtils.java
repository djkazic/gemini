...
/**
 * Object representing filters that are applied on search replies (adult) + generation of BlockedFile And search request responses
 * (hardcode) for a separate, internal "bad" list
 * 
 * @author Kevin Cai
 */
